...
Photographs meet edge to edge on a rotating 3D wheel, with no paper borders. The active year, archival caption and source stay upright below the wheel. Description, map and carousel occupy separate regions: three columns on desktop, a shared description above map and carousel on tablets, and stacked regions on narrow screens.
